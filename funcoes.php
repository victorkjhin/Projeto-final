...
if(isset($_POST['create_paciente'])){
    ...
    $sql = "INSERT INTO pacientes (nome, cpf, telefone, endereco, email, data_nascimento)
            VALUES ('$nome', '$cpf', '$telefone', '$endereco', '$email', '$data_nascimento')";
...
if(isset($_POST['delete_paciente'])){
    ...
    mysqli_query($conexao, "DELETE FROM consultas WHERE id_paciente='$paciente_id'");
    mysqli_query($conexao, "DELETE FROM pacientes WHERE id='$paciente_id'");
...
if(isset($_POST['delete_medico'])){
    ...
    mysqli_query($conexao, "DELETE FROM consultas WHERE id_medico='$medico_id'");
    mysqli_query($conexao, "DELETE FROM medicos WHERE id='$medico_id'");
